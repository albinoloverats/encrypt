...
!define PRODUCT_VERSION    "2024.01"
...
VIAddVersionKey /LANG=${LANG_BRITISH} "LegalCopyright"   "Copyright (c) 2004-2024, ${PRODUCT_PUBLISHER}"
...
VIAddVersionKey /LANG=${LANG_BRITISH} "LegalTrademarks"  "Copyright (c) 2004-2024, ${PRODUCT_PUBLISHER}"
...
Section -encrypt
	...
	File "C:\msys64\mingw64\bin\libunistring-5.dll"
	File "C:\msys64\mingw64\bin\libnghttp2-14.dll"
	File "C:\msys64\mingw64\bin\libcrypto-3-x64.dll"
	File "C:\msys64\mingw64\bin\libssl-3-x64.dll"
