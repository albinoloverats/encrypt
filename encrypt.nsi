...
VIAddVersionKey /LANG=${LANG_BRITISH} "LegalCopyright"   "Copyright (c) 2004-2020, ${PRODUCT_PUBLISHER}"
...
VIAddVersionKey /LANG=${LANG_BRITISH} "LegalTrademarks"  "Copyright (c) 2004-2020, ${PRODUCT_PUBLISHER}"
