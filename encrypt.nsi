...
!define PRODUCT_VERSION    "2022.01"
...
VIAddVersionKey /LANG=${LANG_BRITISH} "LegalCopyright"   "Copyright (c) 2004-2022, ${PRODUCT_PUBLISHER}"
...
VIAddVersionKey /LANG=${LANG_BRITISH} "LegalTrademarks"  "Copyright (c) 2004-2022, ${PRODUCT_PUBLISHER}"
