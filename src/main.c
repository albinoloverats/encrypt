...
int main(int argc, char **argv)
{
...
#ifdef BUILD_GUI
	#ifndef _WIN32
	list_add(args, &((config_arg_t){ 'g', "no-gui",         NULL,            _("Do not use the GUI, even if it’s available"),                                                                            CONFIG_ARG_REQ_BOOLEAN, { .boolean = false }, false, false, false }));
	#endif
...
#endif
	list_add(args, &((config_arg_t){ 'u', "no-cli",         NULL,            _("Do not display the CLI progress bar"),                                                                                   CONFIG_ARG_REQ_BOOLEAN, { .boolean = false }, false, false, false }));
	...
	list_add(args, &((config_arg_t){ 'x', "no-compress",    NULL,            _("Do not compress the plain text using the xz algorithm"),                                                                 CONFIG_ARG_REQ_BOOLEAN, { .boolean = false }, false, false, false }));
