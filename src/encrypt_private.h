...
#define LEGAL_COPYRIGHT	"Copyright (c) 2004-2014, albinoloverats ~ Software Development"
#define LEGAL_TRADEMARKS	""
#define ORIGINAL_FILENAME	"encrypt.exe"
#define PRODUCT_NAME	"encrypt"
#define PRODUCT_VERSION	"2014.XX.0.0"
