...
#define file_encrypted0()        file_encrypted3(-1, (char **)-1, (char **)-1)
#define file_encrypted1(A)       file_encrypted3(A, (char **)-1, (char **)-1)
#define file_encrypted2(A, B)    file_encrypted3(A, B, (char **)-1)

#define file_encrypted(...) COMMON_CONCAT(file_encrypted, IS_ENCRYPTED_ARGS_COUNT(__VA_ARGS__))(__VA_ARGS__)

extern bool file_encrypted3(int64_t f, char **c, char **h); // free(c), don't free(h)
