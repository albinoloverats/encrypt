...
public enum Version
{
    ...
    CURRENT(_201311.magicNumber, _201311.display, _201311.menu_id);
    ...
    public static Version parseMagicNumber(final long m)
    {
    ...
    public static Version parseDisplay(final String d)
    {
        for (final Version v : Version.values())
